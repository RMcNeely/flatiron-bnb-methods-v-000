describe Review do
  ...
  describe 'review validations' do
    ...
    it 'is invalid without an associated reservation, has been accepted, and checkout has happened' do 
      ...
      res = Reservation.create(check_in: '2014-04-05', check_out: '2014-04-29', listing_id: 1, guest_id: 5, :status => "pending")
      new_res = Reservation.create(check_in: '2014-08-01', check_out: Date.today + 1, listing_id: 1, guest_id: 5, :status => "accepted")
