...
def make_reservations
  ...
  # second listing
  Reservation.create!(check_in: '2014-03-10', check_out: '2014-03-25', listing_id: 2, guest_id: User.find_by(id: 5).id, :status => "accepted")
  # last listing
  Reservation.create!(check_in: '2014-06-02', check_out: '2014-06-30', listing_id: 4, guest_id: User.find(6).id, :status => "accepted")
  Reservation.create!(check_in: '2014-05-15', check_out: '2014-06-01', listing_id: 4, guest_id: User.find(5).id, :status => "accepted")
end
